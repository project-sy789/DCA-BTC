...
const BTCAccumulationChart = ({ purchases, currentBTCPrice }) => {
  ...
  const chartData = {
    ...
    datasets: [
      {
        label: 'จำนวน BTC สะสม',
        data: cumulativeData.map(item => item.cumulativeBTC),
        borderColor: '#f7931a',
  ...
  if (allData.length === 0) {
    return (
      <div className="btc-accumulation-chart">
...
BTCAccumulationChart.propTypes = {
...
export default BTCAccumulationChart;
